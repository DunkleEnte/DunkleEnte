            ...
            <div className="max-w-5xl w-full text-center relative">
                ...
                >
                    <div className="group relative inline-flex items-center rounded-2xl border border-white/10 bg-black/40 backdrop-blur-xl overflow-hidden p-1 transition-all duration-500 hover:border-white/20 hover:shadow-[0_0_40px_rgba(255,255,255,0.05)]">
                        <div className="flex items-center gap-4 px-8 py-4 text-white">
                        ...
                        <button
                            ...
                            className="relative cursor-pointer flex items-center justify-center gap-2 min-w-[130px] px-8 py-5 bg-white text-black font-black rounded-xl hover:bg-neutral-200 transition-all duration-300 active:scale-95 uppercase text-[10px] tracking-widest"
                        >
                            {copied ? (
                ...
                >
                    <a
                        ...
                        className="group relative py-2 text-white font-bold text-xs uppercase tracking-[0.3em]"
                    >
                ...
                >
                    <p className="text-[10px] font-bold text-neutral-600 uppercase tracking-[0.4em]">
                        Developed by <span className="text-neutral-400">DunkleEnte</span>
                    </p>
                    <a 
                        href="https://github.com/auvq"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="group relative text-[15px] font-medium text-neutral-700 uppercase tracking-[0.2em] transition-colors hover:text-neutral-500"
                    >
                        Credits @ auvq :3
                        <div className="absolute -bottom-1 left-1/2 -translate-x-1/2 w-0 h-px bg-neutral-700 transition-all duration-300 group-hover:w-full" />
                    </a>
                </motion.div>
